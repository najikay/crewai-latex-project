...
עטלפים אלו מפגינים יכולת מדהימה של פיצוי דופלר (\en{Doppler Shift Compensation}). הם משנים את תדר השידור שלהם כך שההחזר יתקבל תמיד בטווח התדרים שבו האוזן שלהם היא הרגישה ביותר, הנקרא ה-\en{Acoustic Fovea}. \cite{Simmons1979BatSonar}
