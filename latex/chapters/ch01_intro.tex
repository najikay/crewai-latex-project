...
הניווט האוטונומי של כלי-טיס בלתי-מאוישים (\en{UAV})
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\columnwidth]{figures/fig_bat_vs_artificial.png}
...
דיוק הקרוב לדיוק הביולוגי המתועד. \cite{Simmons1979BatSonar}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\columnwidth]{figures/fig_trajectory_3d.png}
